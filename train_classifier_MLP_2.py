...
def init_operations():
    ...
    if args.wandb_name is not None:
        ...
        run = wandb.init(project="RGB-classifiers", entity="egovision-aml23", name = f"{args.models.RGB.model}")
...
def main():
    ...
    for m in modalities:
        ...
        models[m] = getattr(model_list, args.models[m].model)(1024, num_classes, args.num_clips)
